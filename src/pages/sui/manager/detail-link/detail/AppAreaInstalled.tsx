...
const CHART_DATA = [
  {
    year: 2023,
    data: [
      { name: 'Zalo', data: [10, 41, 35, 51, 49, 62, 69, 91, 148] },
      { name: 'Facebook', data: [10, 31, 10, 53, 20, 81, 92, 73, 46] },
      ...
      {CHART_DATA.map((item) => (
        <Box key={item.year} sx={{ mx: 3}} dir="ltr">
          {item.year === seriesData && (
            <ReactApexChart type="line" series={item.data} options={chartOptions} height={220} />
          )}
        </Box>
      ))}
    </Card>
